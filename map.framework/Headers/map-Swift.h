...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="map",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// This class contains all public api for map
SWIFT_CLASS("_TtC3map8MNMapApi")
@interface MNMapApi : NSObject
...
SWIFT_CLASS("_TtC3map9MNMapView")
...
SWIFT_CLASS("_TtC3map19MNMapViewController")
@interface MNMapViewController : GLKViewController
